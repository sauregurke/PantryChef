...
public class recipes extends AppCompatActivity {
    ...
    public void createRecipes(String searchText) {
        String url = "https://api.spoonacular.com/recipes/findByIngredients?ingredients=" + searchText + "&number=30&instructionsRequired=true&apiKey=ef1a4c29f9704500aa8bcd1e00bd0666";
